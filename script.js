...
// Initialize EmailJS with your User ID (replace 'user_xxxx' with your actual User ID)
// emailjs.init("nshrinewarshreya@gmail.com"); // Replace with your EmailJS user ID
